-- Migration 010: Listing Credits fuer Privatpersonen (4,99 EUR / Inserat)
...
-- Tabelle fuer bereits erfuellte Stripe-Sessions (verhindert Doppel-Gutschriften)
...
-- Nur der User selbst darf seine eigenen Eintraege lesen
